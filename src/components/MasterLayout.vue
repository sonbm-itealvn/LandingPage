...
const aboutCards = [
  {
    ...
    body: "45+ giảng viên, kiến trúc sư, nghệ sĩ cộng tác hướng dẫn khóa đồ án",
    color: "#f8b72b",
  },
  {
    title: "Sinh viên tham gia",
    body: "Hơn 1.200 sinh viên các khóa với mạng lưới alumni rộng khắp",
    color: "#ff7ca3",
  },
  {
    title: "Chương trình trao đổi",
    body: "09 đối tác quốc tế với học phần thiết kế chung",
    color: "#20c997",
  },
  {
    title: "Học bổng hỗ trợ",
    body: "12 quỹ tài trợ dành riêng cho đồ án nghiên cứu",
    color: "#8b5cf6",
  },
];
...
const activityCards = [
  {
    title: "Không gian mở",
    body: "Các xưởng sáng tạo hoạt động 24/7 với sự hỗ trợ kỹ thuật",
    color: "#fbff62",
  },
  {
    title: "Hoạt động cộng đồng",
    body: "Chuỗi talk & workshop mỗi tháng với khách mời chuyên gia",
    color: "#4ade80",
  },
  {
    title: "Festival 2025",
    body: "Trình diễn đồ án nổi bật và trao giải thưởng hằng năm",
    color: "#38bdf8",
  },
        ...
        <form class="header-search" role="search" @submit.prevent>
          ...
          <button type="submit" aria-label="Tìm kiếm">
            <svg viewBox="0 0 24 24" aria-hidden="true">
              <path
                d="M15.5 14h-.79l-.28-.27a6 6 0 1 0-.71.71l.27.28v.79L20 20.5 21.5 19zM10 15a5 5 0 1 1 0-10 5 5 0 0 1 0 10z"
              />
            </svg>
          </button>
        </form>
    ...
    <footer class="faculty-footer">
      <div class="faculty-footer__container">
        <div class="faculty-footer__header">
          ...
          <div class="faculty-footer__social">
            ...
            >
              ...
              <svg
                v-else-if="social.modifier === 'youtube'"
                viewBox="0 0 24 24"
                fill="currentColor"
              >
                <path
        ...
        <nav class="faculty-footer__nav">
          ...
          <RouterLink to="/hoat-dong-khoa" class="faculty-footer__nav-link"
            >Hoạt động khoa</RouterLink
          >
          <RouterLink to="/thong-bao" class="faculty-footer__nav-link">Thông báo</RouterLink>
          <RouterLink to="/hop-tac-ket-noi" class="faculty-footer__nav-link"
            >Hợp tác - kết nối</RouterLink
          >
        </nav>
        ...
        <div class="faculty-footer__content">
          <div class="faculty-footer__description">
            <p>
              Khoa Kiến trúc là một trong những khoa đầu tiên được thành lập cùng với trường đại học
              Kiến trúc từ năm 1961, trải qua hơn 60 năm hoạt động và đào tạo, đóng vai trò hạt nhân
              trong việc hình thành và phát triển nguồn nhân lực kiến trúc tại Việt Nam.
            </p>
          </div>
